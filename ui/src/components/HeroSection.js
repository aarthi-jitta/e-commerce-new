...
<p className='text-4xl mt-24 text-center welcomStore' style={{ color: '#7d70ba' }}>Welcome to K-Beauty Store</p>
            <br />
            <br />


            <p className='heroDescription relative text-xl flex flex-wrap' style={{ color: '#ff1493' }}> The self care brand that's setting a new standard. Natural products, to help
