    ...
    return (
        <div className='u20MainParent fof '>
            ...
            <div className='u20HeadingHold gap-20 justify-center relative flex flex-col'>
                <p className='u20Heading'>Natural Gifts For MEN </p>
                <p className='u20Desc'> Shop K-Beauty natural and vegan collection of skincare and hair care gifts under $20.</p>
            </div>
